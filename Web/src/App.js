...
const CONTRACT_ADDRESS = "0x51f5C1Ac02aDA1519746131067732f0946849032";

// Constants
const TWITTER_HANDLE = 'Umarham5';
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
const OPENSEA_LINK = 'https://testnets.opensea.io/collection/umarnft-v3';
      ...
      <div className="container">
        <div className="header-container">
          ...
          <p className="sub-text">
            Each NFT as a Unique name. Discover your NFT today.
          </p>
          {correctNetwork && (
            <>
              {currentAccount === "" ? (
